...
#Region "Function"
    ...
    Public Function GetBudgetCompareData() As Boolean
        ...
        If clsBG_T_UPLOAD_DATA.Select006() = False Then
            Return False
        End If
        clsBG_T_UPLOAD_DATA.dtResult.TableName = "BUDGET_COMPARE_INVESTMENT"
    ...
    Public Function GetPersonInChargeList() As Boolean
        ...
        If clsBG_M_PERSON_IN_CHARGE.Select013() = False Then
