...
#Region "Function"
    ...
    Public Function GetBudgetCompareData() As Boolean
        ...
        clsBG_T_UPLOAD_DATA.UserPIC = Me.PIC
    ...
    Public Function GetPersonInChargeList() As Boolean
        ...
        If clsBG_M_PERSON_IN_CHARGE.Select001() = False Then
    ...
    Public Function GetPersonInChargeList2() As Boolean

        Dim clsBG_M_PERSON_IN_CHARGE As BG_M_PERSON_IN_CHARGE = New BG_M_PERSON_IN_CHARGE()

        clsBG_M_PERSON_IN_CHARGE.UserPIC = Me.PIC

        If clsBG_M_PERSON_IN_CHARGE.Select009() = False Then
            clsBG_M_PERSON_IN_CHARGE = Nothing
            Return False
        End If
