...
Public Class RPT005_4_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BudgetManual.RPT005-4_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT005_4_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT005_4_old = New RPT005_4_old
        rpt.Site = Me.Site
        Return rpt
    End Function
