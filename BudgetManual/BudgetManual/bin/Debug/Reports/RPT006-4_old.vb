...
Public Class RPT006_4_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BudgetManual.RPT006-4_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT006_4_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT006_4_old = New RPT006_4_old
        rpt.Site = Me.Site
        Return rpt
    End Function
