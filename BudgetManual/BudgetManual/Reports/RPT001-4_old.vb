...
Public Class RPT001_4_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BudgetManual.RPT001-4_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PERSON_IN_CHARGE_NM() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT001_4_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT001_4_old = New RPT001_4_old
        rpt.Site = Me.Site
        Return rpt
    End Function
