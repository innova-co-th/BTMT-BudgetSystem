...
Partial Public Class DS006
    ...
    Partial Public Class ESTIMATE_BUDGETDataTable
        ...
        Public Overloads Function AddESTIMATE_BUDGETRow( _
                    ...
                    ByVal ESTIMATE_TOTAL_YEAR As Double) As ESTIMATE_BUDGETRow
            Dim rowESTIMATE_BUDGETRow As ESTIMATE_BUDGETRow = CType(Me.NewRow,ESTIMATE_BUDGETRow)
            Dim columnValuesArray() As Object = New Object() {ASSET_PROJECT, ASSET_PROJECT_NAME, ASSET_CATEGORY, ASSET_CATEGORY_NAME, ASSET_GROUP_NO, ASSET_GROUP_NAME, BUDGET_ORDER_NAME, BUDGET_ORDER_NO, COST_CENTER, PERSON_IN_CHARGE_NO, ACTUAL_FIRST_HALF, REVISE_SECOND_HALF, M7, M8, M9, M10, M11, M12, ESTIMATE_SECOND_HALF, DIFF_SECOND_HALF, ESTIMATE_TOTAL_YEAR}
