...
#Region "Variable"
    ...
    Private myClsBG0470BL As New clsBG0470BL
...
#Region "Function"
    ...
    Private Function InitPage() As Boolean
        ...
        Try
            ...
            If p_intUserLevelId < enumUserLevel.GeneralManager Then
                If myClsBG0470BL.GetPersonInChargeList() = False Then
                    cboUserPIC.DataSource = Nothing
                Else
                    Dim dt As DataTable = myClsBG0470BL.PersonInCharge
                    ...
                    cboUserPIC.DataSource = myClsBG0470BL.PersonInCharge
                    cboUserPIC.DisplayMember = "PIC_NAME"
                    cboUserPIC.ValueMember = "PERSON_IN_CHARGE_NO"
                    cboUserPIC.SelectedIndex = 0
                End If
            Else
                myClsBG0470BL.PIC = p_strUserPIC
                If myClsBG0470BL.GetPersonInChargeList2() = False Then
                    cboUserPIC.DataSource = Nothing
                Else
                    cboUserPIC.DataSource = myClsBG0470BL.PersonInCharge
                    cboUserPIC.DisplayMember = "PIC_NAME"
    ...
    Private Sub Print(ByVal blnShowPrintPreview As Boolean)
        ...
        Try
            ...
            myClsBG0470BL.BudgetYear = CStr(Me.numYear.Value)
            myClsBG0470BL.Month = Me.cboMonth.Text
            myClsBG0470BL.PIC = Me.cboUserPIC.SelectedValue.ToString
            myClsBG0470BL.UserLevelId = p_intUserLevelId

            If myClsBG0470BL.getBudgetCompareData() Then

                Dim ds As DataSet = myClsBG0470BL.BudgetCompareData

                If ds IsNot Nothing AndAlso ds.Tables(0).Rows.Count > 0 Then

                    myClsBG0470BL.GetBudgetStatus()

                    strReportName = "RPT007.rpt"
                    ...
                    If blnShowPrintPreview Then
                        ...
                        clsBG0400.BudgetStatus = myClsBG0470BL.BudgetStatus
                    ...
                    Else
                        ...
                        If (result = DialogResult.OK) Then
                            ...
                            'If myClsBG0470BL.BudgetStatus >= 5 Then
                            ...
                            'If myClsBG0470BL.BudgetStatus >= 6 Then
    ...
    Private Function OutputExcel(ByVal dsData As DataSet, ByVal dtColumns As DataTable, ByVal bMTPCheck As Boolean, _
        ...
        For intSheetCount As Integer = 0 To dsData.Tables.Count - 1
            ...
            SetupCompareColumnsCells(xSt, colStartIndex, CInt(strMonth), 1, 2, "Budget Order Number & Budget Name", _
...
#Region "Controls Event"
    ...
    Private Sub frmBG0470_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
    ...
    Private Sub frmBG470_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub cmdExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdExcel.Click
        ...
        Dim dtAuthorizeImages As DataTable = myClsBG0470BL.BudgetCompareData.Tables(1)
        ...
        Dim strSubTitle As String = "Detail by Person In Charge : Budget Compare Year " + strYear

        InsertExcelColumnData(dtColumns, strYear, strMonth)
        CalculateDiff(strMonth, dsData)

        '//Create group data
        Dim dsGroups As DataSet = SetupCompareGroupbyData(strMonth, dsData, "PERSON_IN_CHARGE", "PERSON_IN_CHARGE_NAME", 12, True)
