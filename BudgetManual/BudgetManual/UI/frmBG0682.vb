...
Public Class frmBG0682

#Region "Variable"
    Private myClsBG0682BL As New clsBG0682BL
...
#Region "Function"
    Public Sub setGridHeaderText()
        Me.grvMaster.Columns("ASSET_PROJECT").HeaderText = "No"
        Me.grvMaster.Columns("ASSET_PROJECT_TXT").HeaderText = "Asset project name"
    ...
    Public Sub setGridHeaderProperty()
        Me.grvMaster.Columns("ASSET_PROJECT").AutoSizeMode = DataGridViewAutoSizeColumnMode.None
        Me.grvMaster.Columns("ASSET_PROJECT").Width = 40
        Me.grvMaster.Columns("ASSET_PROJECT").MinimumWidth = 40
        Me.grvMaster.Columns("ASSET_PROJECT").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter

        Me.grvMaster.Columns("ASSET_PROJECT_TXT").AutoSizeMode = DataGridViewAutoSizeColumnMode.None
        Me.grvMaster.Columns("ASSET_PROJECT_TXT").Width = 150
        Me.grvMaster.Columns("ASSET_PROJECT_TXT").MinimumWidth = 150
    ...
    Public Sub SearchDataGrid()
        ...
        myClsBG0682BL.AssetProjectFilter = Me.txtProjectNoFilter.Text.Trim
        myClsBG0682BL.AssetProjectTxtFilter = Me.txtProjectNameFilter.Text.Trim

        If myClsBG0682BL.getAssetProject() = True Then
            dtMaster = myClsBG0682BL.DtResult
            Me.grvMaster.DataSource = dtMaster

            setGridHeaderText()
            setGridHeaderProperty()
        Else
            MessageBox.Show("Error: Can not get Asset project information!", Me.Text, MessageBoxButtons.OK, _
    ...
    Public Sub setText(ByVal intRow As Integer)
        ...
        Me.txtProjectNo.Text = CStr(Me.grvMaster.Rows(intRow).Cells("ASSET_PROJECT").Value)
        Me.txtProjectName.Text = CStr(Me.grvMaster.Rows(intRow).Cells("ASSET_PROJECT_TXT").Value)
    End Sub

    Public Function checkData(ByVal strProjectNo As String) As Boolean
        myClsBG0682BL.AssetProject = strProjectNo

        If myClsBG0682BL.checkData() = True Then
            If myClsBG0682BL.DtResult.Rows.Count > 0 Then
                Return True
            Else
                Return False
            End If
    ...
    Private Sub clearFilter()
        Me.txtProjectNoFilter.Text = ""
        Me.txtProjectNameFilter.Text = ""
    End Sub
#End Region
...
#Region "Control Event"
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        Me.txtProjectNo.Text = String.Empty
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If isInsert = True Then
            If MessageBox.Show("Are you sure to create new Asset project?", Me.Text, MessageBoxButtons.YesNo, _
                          MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
                Exit Sub
            End If

            myClsBG0682BL.AssetProject = Me.txtProjectNo.Text
            myClsBG0682BL.AssetProjectTxt = Me.txtProjectName.Text
            myClsBG0682BL.CreateUserId = p_strUserId

            If myClsBG0682BL.insertOneData() = True Then
                MessageBox.Show("Asset project was created", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)

                '// Write Transaction Log
                WriteTransactionLog(CStr(enumOperationCd.EditAssetProjectMaster), "", "", "", "", "", "")

                SearchDataGrid()
            Else
                If myClsBG0682BL.DtResult.Rows.Count >= 1 Then
                    MessageBox.Show("Asset project" & Me.txtProjectNo.Text & " is exist", Me.Text, MessageBoxButtons.OK, _
                                    MessageBoxIcon.Information)
                Else
                    MessageBox.Show("There are error between save Asset project", Me.Text, MessageBoxButtons.OK, _
                                    MessageBoxIcon.Error)
                End If
            End If
        Else
            If MessageBox.Show("Are you sure to update Asset project?", Me.Text, MessageBoxButtons.YesNo, _
                          MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
                Exit Sub
            End If
            ...
            findTheseVals(0) = Me.txtProjectNo.Text
            dr = dt.Rows.Find(findTheseVals)

            myClsBG0682BL.AssetProject = Me.txtProjectNo.Text
            myClsBG0682BL.AssetProjectTxt = Me.txtProjectName.Text
            myClsBG0682BL.UpdateUserId = p_strUserId

            If myClsBG0682BL.UpdateOneData() = True Then
                MessageBox.Show("Asset project was updated", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        If MessageBox.Show("Are you sure to delete Asset project?", Me.Text, MessageBoxButtons.YesNo, _
                      MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
        ...
        If myClsBG0682BL.DeleteData() = True Then
            MessageBox.Show("Asset project was deleted", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
            SearchDataGrid()
        Else
            MessageBox.Show("There are error between delete Asset project", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
        ...
        Try
            For Each row As DataRow In dt.Rows
                ...
                If checkData(row(0).ToString) = True Then
                    '// update
                    myClsBG0682BL.AssetProject = row(0).ToString
                    myClsBG0682BL.AssetProjectTxt = row(1).ToString
                    myClsBG0682BL.UpdateUserId = p_strUserId

                    If myClsBG0682BL.UpdateExcelData(conn, trans) = True Then
                        success = True
                    Else
                        success = False
                        Exit For
                ...
                Else
                    ...
                    If myClsBG0682BL.insertExcelData(conn, trans) = True Then
                        success = True
                    Else
                        success = False
                        Exit For
    ...
    Private Sub cmdExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdExport.Click
        ...
        sdlgSave.FileName = "AssetProjectMaster_" & Format(Date.Now, "yyyyMMdd")
        ...
        excel.Cells(1, 1) = "Asset project no"
        excel.Cells(1, 2) = "Asset project name"
