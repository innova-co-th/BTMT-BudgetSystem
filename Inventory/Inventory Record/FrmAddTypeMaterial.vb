...
Public Class FrmAddTypeMaterial
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmAddTypeMaterial))
...
#Region "Type"
    Private Function ChkDataType() As Boolean
        ...
        Try
            strSQL &= " select count(*) from TBLTypeMaterial "
            strSQL &= " where MaterialCode  = '" & TxtNo.Text.Trim & "'"
    ...
    Private Function iNoType() As Long
        ...
        Try
            ...
            strSQL = "  SELECT   top 1 MaterialCode "
            strSQL &= "  FROM   TBLTypeMaterial"
            strSQL &= "  order by MaterialCode desc"
            ...
            If drSQL.HasRows Then
                If drSQL.Read() Then
                    iNoType = CLng(drSQL.Item("MaterialCode").ToString())
                End If
            End If
    ...
    Sub Type()
        ...
        ElseIf CmdSave.Text = "Edit" Then
            ...
            Me.Cursor = System.Windows.Forms.Cursors.WaitCursor()
            Try
                strSQL &= " Update TBLTypeMaterial"
                strSQL &= " set MaterialName = '" & TxtName.Text.Trim & "'"
                If CheckBox1.Checked = True Then
                    strSQL &= " , DescName = 'Semi'"
                Else
                    strSQL &= " , DescName = 'PreSemi'"
                End If
                strSQL &= " where MaterialCode = '" & TxtNo.Text.Trim & "'"
                cnSQL = New SqlConnection(C1.Strcon)
                cnSQL.Open()
...
#End Region
    ...
    Private Sub FrmAddTypeMaterial_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i As Integer
        If CmdSave.Text = "Save" Then
            i = iNoType() + 1
