...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmAddLoc))
...
#Region "Loc"
    Private Function ChkDataLoc() As Boolean
        Dim cnSQL As SqlConnection
        Dim cmSQL As SqlCommand
        Dim strSQL As String = String.Empty
        Try
            strSQL &= " select count(*) from TBLLoc "
            strSQL &= " where Loccode  = '" & TxtNo.Text.Trim & "'"
        ...
        End Try
    End Function
    Private Function iNoLoc() As Long
        Dim cnSQL As SqlConnection
        Dim cmSQL As SqlCommand
        ...
        Try
            ...
            strSQL = "  SELECT   top 1 LocCode "
            strSQL &= "  FROM   TBLLOC"
            strSQL &= "  order by LocCode desc"
            ...
            If drSQL.HasRows Then
                If drSQL.Read() Then
                    iNoLoc = CLng(drSQL.Item("LocCode").ToString())
                End If
            End If
    ...
    Sub Loc()
        ...
        ElseIf CmdSave.Text = "Edit" Then
            ...
            Me.Cursor = System.Windows.Forms.Cursors.WaitCursor()
            Try
                strSQL &= " Update TBLLoc"
                strSQL &= " set LocName = '" & TxtName.Text.Trim & "'"
                strSQL &= " where LocCode = '" & TxtNo.Text.Trim & "'"
                cnSQL = New SqlConnection(C1.Strcon)
                cnSQL.Open()
                cmSQL = New SqlCommand(strSQL, cnSQL)
...
#End Region
    ...
    Private Sub CmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSave.Click
        ...
        msg = "Location New" ' Define message.
        style = MsgBoxStyle.DefaultButton2 Or _
           MsgBoxStyle.Information Or MsgBoxStyle.YesNo
        title = "Location"   ' Define title.
    ...
    Private Sub FrmAddLoc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i As Integer
        If CmdSave.Text = "Save" Then
            i = iNoLoc() + 1
