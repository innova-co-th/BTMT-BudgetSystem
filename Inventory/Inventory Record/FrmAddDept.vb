...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmAddDept))
...
#Region "Dept"
    Private Function ChkDataDept() As Boolean
        Dim cnSQL As SqlConnection
        Dim cmSQL As SqlCommand
        Dim strSQL As String = String.Empty
        Try
            strSQL &= " select count(*) from TblDepartment "
            strSQL &= " where Deptcode  = '" & TxtNo.Text.Trim & "'"
        ...
        End Try
    End Function
    Private Function iNoDept() As Long
        Dim cnSQL As SqlConnection
        Dim cmSQL As SqlCommand
        ...
        Try
            ...
            strSQL = "  SELECT   top 1 DeptCode "
            strSQL &= "  FROM   TblDepartment"
            strSQL &= "  order by DeptCode desc"
            ...
            If drSQL.HasRows Then
                If drSQL.Read() Then
                    iNoDept = CLng(drSQL.Item("DeptCode").ToString())
                End If
            End If
    ...
    Sub Dept()
        ...
        ElseIf CmdSave.Text = "Edit" Then
            ...
            Me.Cursor = System.Windows.Forms.Cursors.WaitCursor()
            Try
                strSQL &= " Update TblDepartment"
                strSQL &= " set DeptName = '" & TxtName.Text.Trim & "'"
                strSQL &= " where deptCode = '" & TxtNo.Text.Trim & "'"
                cnSQL = New SqlConnection(C1.Strcon)
                cnSQL.Open()
                cmSQL = New SqlCommand(strSQL, cnSQL)
...
#End Region
    ...
    Private Sub CmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSave.Click
        ...
        msg = "Department New" ' Define message.
        style = MsgBoxStyle.DefaultButton2 Or _
           MsgBoxStyle.Information Or MsgBoxStyle.YesNo
        title = "Department"   ' Define title.
