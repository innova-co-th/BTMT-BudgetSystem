...
Public Class FrmPHYViewGroupMat
#Region "Declare"
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmPHYViewGroupMat))
        ...
        Me.Name = "FrmPHYViewGroupMat"
        Me.Text = "View Physical Report By Material Group"
...
#End Region
    Dim ds2 As New DataSet("Dataset4")


    Private Sub FrmPHYViewGroupMat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dt_new.TableName = "TBL_Group"
        ds2.Tables.Add(dt_new)
        sOutAs = " Physical Check Work in Process by Tag."
        sDt = Now.Date
        sDesc = ""
        Dim r1 As New PHYReportGroupMat
    ...
    Private Sub FrmPHYViewGroupMat_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        ds2.Tables.Remove("TBL_Group")
        ds2.Dispose()
    End Sub
End Class
