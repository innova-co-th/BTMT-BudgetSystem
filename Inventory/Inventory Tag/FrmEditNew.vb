...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEditNew))
        ...
        Me.GrdItem.Size = New System.Drawing.Size(666, 101)
        ...
        Me.cmdOK.Location = New System.Drawing.Point(528, 254)
        Me.cmdOK.Name = "cmdOK"
        ...
        Me.cmdCancel.Location = New System.Drawing.Point(606, 254)
        ...
        Me.cmbLoc.Size = New System.Drawing.Size(200, 21)
        Me.cmbLoc.TabIndex = 6
        '
        'Label4
        '
        ...
        'RB1
        '
        Me.RB1.Location = New System.Drawing.Point(360, 8)
        Me.RB1.Name = "RB1"
        Me.RB1.Size = New System.Drawing.Size(136, 16)
        Me.RB1.TabIndex = 11
        Me.RB1.Text = "1 st Year"
        '
        'RB2
        '
        Me.RB2.Location = New System.Drawing.Point(360, 32)
        Me.RB2.Name = "RB2"
        Me.RB2.Size = New System.Drawing.Size(136, 16)
        Me.RB2.TabIndex = 61
        ...
        '
        Me.RB3.Checked = True
        Me.RB3.Location = New System.Drawing.Point(360, 56)
        Me.RB3.Name = "RB3"
        ...
        Me.cmbType.Location = New System.Drawing.Point(64, 80)
        ...
        Me.cmbCode.Location = New System.Drawing.Point(296, 80)
        Me.cmbCode.Name = "cmbCode"
        Me.cmbCode.Size = New System.Drawing.Size(120, 21)
        Me.cmbCode.TabIndex = 68
        '
        'Label1
        '
        ...
        'CHK1
        '
        Me.CHK1.Location = New System.Drawing.Point(16, 82)
        Me.CHK1.Name = "CHK1"
        Me.CHK1.Size = New System.Drawing.Size(16, 16)
        Me.CHK1.TabIndex = 71
        '
        'FrmEditNew
        '
...
#End Region
    ...
    Private Sub FrmEditNew_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
{grdColStyle1, grdColStyle6, grdColStyle5})
    ...
    End Sub
    Private Sub setGrid_New()
        Dim dt As DataTable = New DataTable()
        Dim StrSQL As String
        Dim tLoc() As String
        tLoc = Split(cmbLoc.Text.Trim, "-")
        Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
        StrSQL = " SELECT     * "
        StrSQL &= "   FROM  TBLTRX "
        StrSQL &= " where location = '" & tLoc(0).Trim & "'"
        StrSQL &= " and  tagno  = '" & TxtTagNo.Text.Trim & "'"
        If RB1.Checked Then
            StrSQL &= " and  period  = 'YL' and trxyear = '" & DPeriod.Value.Year & "01'"
        ElseIf RB2.Checked Then
            StrSQL &= " and  period  = 'YL' and trxyear = '" & DPeriod.Value.Year & "02'"
        ElseIf RB3.Checked Then
            StrSQL &= " and  period  = 'ML'"
            StrSQL &= " and  trxyear  = '" & DPeriod.Value.Year & Format(CInt(DPeriod.Value.Month), "#00") & "'"
        End If
...
#Region "Form Keydown F5 & Esc"
    ...
    Private Sub FrmEditNew_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
            ...
            For Each dr In aDr
                With dr
                    If IIf(.Item("Code") Is System.DBNull.Value, "", .Item("Code")) <> "" Then
                        ...
                        strsql += "," & PrepareStr(strDate3(1) + Ytrx)
...
#End Region
    ...
    Private Sub DPeriod_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DPeriod.ValueChanged
        If CHK1.Checked Then
            PopulateTypeComboType()
            ShowData()
        Else
