...
Public Class Reportscrap1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory_Tag.Reportscrap1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportscrap1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reportscrap1 = New Reportscrap1()
        rpt.Site = Me.Site
        Return rpt
    End Function
